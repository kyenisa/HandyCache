...
function BeforeViewInMonitor()
	if re.match(hc.url, [[.*(oneoneoneone|:443|:1001|:5228|chat|/search|min.js|BlueBox|app.standsapp.org|newtab|blogID|chrome-sync/command|api/stats/qoe|gen_204|osname).*]]) then
